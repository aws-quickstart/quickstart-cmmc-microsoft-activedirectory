...
:quickstart-project-name: quickstart-cmmc-microsoft-activedirectory
...
:quickstart-contributors: Mike Whalen, AWS Cloud Architect, Dave May, {quickstart-team-name}, and Troy Ameigh, {quickstart-team-name}
